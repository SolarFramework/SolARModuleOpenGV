...
double Triangulation::triangulate(const std::vector<SolAR::datastructure::Point2Df> & pointsView1,
                                  ...
                                  std::vector<SRef<SolAR::datastructure::CloudPoint>> & pcloud)
{
    ...
    Eigen::Matrix<float,3,3> k1_invert =  camParams1.intrinsic.inverse();
    Eigen::Matrix<float,3,3> k2_invert =  camParams2.intrinsic.inverse();
    ...
    buffer_vector_B.resize(numberPoints);
     ...
     for (size_t i = 0; i<numberPoints; i++) {
        ...
        buffer_vector_A[i] = k1_invert*Vector3f( (float)pointsView1[matches[i].getIndexInDescriptorA()].getX(), (float)pointsView1[matches[i].getIndexInDescriptorA()].getY(), 1.0);
        ...
        buffer_vector_B[i] = k2_invert*Vector3f( (float)pointsView2[matches[i].getIndexInDescriptorB()].getX(), (float)pointsView2[matches[i].getIndexInDescriptorB()].getY(), 1.0);
    ...
    LOG_INFO(" FOR NOW ITS REPROJECTION ERROR IS SET TO 0...:" );
        ...
        Eigen::Vector3f undistort_point =  k1_invert* Eigen::Vector3f((float)pointsView1[matches[k].getIndexInDescriptorA()].getX(),(float)pointsView1[matches[k].getIndexInDescriptorA()].getY(),1.0f);
#if NDEBUG          
...
double Triangulation::triangulate(const std::vector<SolAR::datastructure::Keypoint> & keypointsView1,
                                  ...
                                  std::vector<SRef<SolAR::datastructure::CloudPoint>> & pcloud)
{
    ...
    buffer_vector_B.resize(numberPoints);
     ...
     for (size_t i = 0; i<numberPoints; i++) {
        ...
        buffer_vector_A[i] = k1_invert*Vector3f( (float)keypointsView1[matches[i].getIndexInDescriptorA()].getX(), (float)keypointsView1[matches[i].getIndexInDescriptorA()].getY(), 1.0);
        bearingVectors1.push_back(opengv::point_t( buffer_vector_A[i][0],buffer_vector_A[i][1],buffer_vector_A[i][2]));
        bearingVectors1[i] /= bearingVectors1[i].norm();

        buffer_vector_B[i] = k2_invert*Vector3f( (float)keypointsView2[matches[i].getIndexInDescriptorB()].getX(), (float)keypointsView2[matches[i].getIndexInDescriptorB()].getY(), 1.0);
        bearingVectors2.push_back(opengv::point_t( buffer_vector_B[i][0],buffer_vector_B[i][1],buffer_vector_B[i][2]));
        bearingVectors2[i] /= bearingVectors1[i].norm();
     }
    ...
    for(size_t k = 0; k < numberPoints; k++){
        ...
        Eigen::Vector3f undistort_point =  k1_invert* Eigen::Vector3f((float)keypointsView1[matches[k].getIndexInDescriptorA()].getX(),(float)keypointsView1[matches[k].getIndexInDescriptorA()].getY(),1.0f);
